...
static void init(GLFWwindow* window)
{
	...
	g_shaderProgramID = loadShaders("MultiTexVS.vert", "MultiTexFS.frag");
	...
	glVertexAttribPointer(texCoordIndex1, 2, GL_FLOAT, GL_FALSE, sizeof(Vertex), reinterpret_cast<void*>(offsetof(Vertex, texCoord1)));
	glVertexAttribPointer(texCoordIndex2, 2, GL_FLOAT, GL_FALSE, sizeof(Vertex), reinterpret_cast<void*>(offsetof(Vertex, texCoord2)));
...
static void render_scene()
{
	...
	// activate texture unit0 and bind it to the appropriate texture
	glActiveTexture(GL_TEXTURE0);
	glBindTexture(GL_TEXTURE_2D, g_textureID[0]);

	// activate texture unit1 and bind it to the appropriate texture
