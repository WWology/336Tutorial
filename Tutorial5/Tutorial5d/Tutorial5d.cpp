...
static void init(GLFWwindow* window)
{
	...
	g_shaderProgramID = loadShaders("MultiLightsVS.vert", "MultiLightsFS.frag");
	...
	g_light[1].diffuse = glm::vec3(1.0f, 0.0f, 0.5f);
	g_light[1].specular = glm::vec3(1.0f, 0.0f, 0.5f);
	g_light[1].type = 0;
...
{
	// update model matrix
	g_modelMatrix = glm::rotate(glm::radians(g_rotateAngleX), glm::vec3(1.0f, 0.0f, 0.0f)) * glm::rotate(glm::radians(g_rotateAngleY), glm::vec3(0.0f, 1.0f, 0.0f)) * glm::scale(glm::vec3(g_scale, g_scale, g_scale));
}
...
int main(void)
{
	...
	TwAddVarRW(TweakBar, "Light0: x", TW_TYPE_FLOAT, &g_light[0].position[0], " group='Light 0' min=-10.0 max=10.0 step=0.1");
	TwAddVarRW(TweakBar, "Light0: y", TW_TYPE_FLOAT, &g_light[0].position[1], " group='Light 0' min=-10.0 max=10.0 step=0.1");
	TwAddVarRW(TweakBar, "Light0: z", TW_TYPE_FLOAT, &g_light[0].position[2], " group='Light 0' min=-10.0 max=10.0 step=0.1");

	TwAddVarRW(TweakBar, "Light1: x", TW_TYPE_FLOAT, &g_light[1].position[0], " group='Light 1' min=-10.0 max=10.0 step=0.1");
	TwAddVarRW(TweakBar, "Light1: y", TW_TYPE_FLOAT, &g_light[1].position[1], " group='Light 1' min=-10.0 max=10.0 step=0.1");
	TwAddVarRW(TweakBar, "Light1: z", TW_TYPE_FLOAT, &g_light[1].position[2], " group='Light 1' min=-10.0 max=10.0 step=0.1");
